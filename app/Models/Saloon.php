...
use Illuminate\Foundation\Auth\Saloon as Authenticatable;
use Laratrust\Traits\LaratrustUserTrait;

class Saloon extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'manager_name', 'contact', 'postal_code','city'
    ];
    ...
    public function availability(){
        return $this->hasMany(SaloonAvailability::class);
    }
